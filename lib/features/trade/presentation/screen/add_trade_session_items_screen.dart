...
class AddTradeSessionItemsScreen extends ConsumerStatefulWidget {
  const AddTradeSessionItemsScreen({
    super.key,
  ...
  @override
  ConsumerState<AddTradeSessionItemsScreen> createState() =>
      _AddTradeSessionItemsScreenState();
}
...
class _AddTradeSessionItemsScreenState
    extends ConsumerState<AddTradeSessionItemsScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await ref
          .read(tradeSessionDetailNotifierProvider(widget.tradeSessionId).notifier)
          .addItems(items);
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        _isSubmitting
                            ? 'Adding...'
                            : 'Add Items (${_selectedItemsMap.length})',
                        style: TextStyle(
                          fontSize: 15.sp,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '$count item${count > 1 ? 's' : ''} ready to add',
                  style: TextStyle(
                    fontSize: 12.sp,
