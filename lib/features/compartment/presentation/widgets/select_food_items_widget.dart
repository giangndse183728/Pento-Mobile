...
class SelectFoodItemsWidget extends ConsumerStatefulWidget {
  const SelectFoodItemsWidget({
    super.key,
  ...
  final void Function(CompartmentItem item, bool isSelected) onSelectionChanged;

  @override
  ConsumerState<SelectFoodItemsWidget> createState() =>
      _SelectFoodItemsWidgetState();
}

class _SelectFoodItemsWidgetState
  ...
  void _toggleSelection(CompartmentItem item) {
    final isCurrentlySelected = widget.selectedItemIds.contains(item.id);
    widget.onSelectionChanged(item, !isCurrentlySelected);
  }
    ...
    return Column(
      ...
      children: [
        ...
        _FoodItemsFilterCard(
          ...
          totalCount: foodItemsAsync.valueOrNull?.totalCount ?? 0,
